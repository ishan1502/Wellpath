...
const Messages = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-80px)]">
          ...
          <div className="p-4 border-b border-gray-100">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-emerald-500"
              />
            </div>
          </div>
          ...
          <div className="p-4 bg-white border-t border-gray-100">
            <form onSubmit={handleSend} className="flex gap-2">
              <input
                ...
                className="flex-grow bg-gray-50 border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500"
              />
              <button 
                type="submit"
